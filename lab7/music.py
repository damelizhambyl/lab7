...
music_folder = "/Users/zhambyldameli/Desktop/lab7/music"
...
pygame.display.set_caption("Dameli-Playlist")
clock = pygame.time.Clock()

# артқы фонды енгіземіз
background = pygame.image.load(os.path.join("music elements", "dameli.jpeg"))
